...
<form action="index.php?m=Item&c=Index&a=doChange&id=<?php echo ($data["id"]); ?>" method="post" enctype="multipart/form-data">
	<table>
		...
		<tr>
			<td>酒精度:</td><td><input name="alcohol" value="<?php echo ($data["alcohol"]); ?>"/></td>
		</tr>
		<tr>
			<td>饮酒温度:</td><td><input name="tempera" value="<?php echo ($data["tempera"]); ?>"/></td>
		</tr>
		<tr>
			<td>酒等级:</td><td><input name="level" value="<?php echo ($data["level"]); ?>"/></td>
		</tr>
		<tr>
