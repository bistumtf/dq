...
try { ace.settings.check('sidebar', 'fixed') } catch (e) { }
			...
			<ul class="nav nav-list">
				...
				<a href="javascript:jump(2)">
					...
					<span class="menu-text"> 礼品 </span>

				</a>
				</li>

				<li>
				<a href="javascript:jump(3)">
					<i class="icon-text-width"></i>
					<span class="menu-text">  酒 </span>

				</a>
				</li>

				<li>
				<a href="javascript:jump(3)" class="dropdown-toggle">
					<i class="icon-desktop"></i>
					<span class="menu-text"> 洒</span>
...
try { ace.settings.check('sidebar', 'collapsed') } catch (e) { }
		...
		<div style="float:left;width:87%;height:700px">
			<iframe id="iframe_main" style="width:100%;height:100%" src=""></iframe>
		</div>

		<script>
function jump(param){
	if(param==1){
		$("#iframe_main").attr("src","http://dq/index.php?m=Home&c=Index&a=homePage");
	}
	if(param==2){
		$("#iframe_main").attr("src","http://dq/index.php?m=Item&c=Index&a=homePage");
	}
	if(param==3){
		$("#iframe_main").attr("src","http://dq/index.php?m=Item&c=Index&a=liquor_list");
	}
	if(param==4){
		$("#iframe_main").attr("src","http://dq/index.php?m=Home&c=Index&a=homePage");
	}
